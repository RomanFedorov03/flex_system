@foreach($project->columns->sortBy('number') as $column)
...
<div class=" column-create">
    <div class="w-100 card d-flex flex-column align-items-start p-1">
        <input class="form-control mb-1" id="column-name" type="text" placeholder="{{__('Ввести заголовок колонки')}}">
        <button class="btn btn-success" onclick="kanbanCreateElem(this)" data-type="column" data-pr="{{$project->id}}">{{__('Добавить')}}</button>
    </div>
 </div>
